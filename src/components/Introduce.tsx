...
const Introduce: FC = () => {
  return (
    <div className="relative w-full">
      <img className="absolute h-screen w-full object-cover" src={Surfing} alt="surfing" />
      <div className="absolute h-48 w-full bg-gradient-to-b from-[#01353E]" />
      <div className="absolute flex h-screen w-full flex-col items-stretch pt-5">
        ...
        <p className="m-auto text-center leading-tight pb-16">
