		...
		<section id="service" className="grid place-content-center gap-y-20">
			...
			<div className="flex justify-center">
				<div className="inline-block space-y-20">
					<div className="mt-10 flex flex-col items-center justify-center gap-x-16 gap-y-8 md:flex-row ">
						<div className="max-w-[350px] space-y-4">
							...
							<p className="description !mt-0">
								Our surf school is located 100 m from the ocean coast. It
								features an outdoor pool and free Wi-Fi. The upper terrace
								offers ocean views. Distance to city center 15 min.
							</p>
						</div>
						<div className="max-w-[350px] space-y-4">
							<div className="flex h-16 place-content-center place-items-center gap-x-3">
							...
							<p className="description !mt-0">
								All program participants are insured by Allianz insurance
								company. Flights from Tenerife to Lanzarote and back are
					...
					<div className="flex flex-col items-center justify-between gap-y-5 md:flex-row">
						...
						<p className="description max-w-[600px]">
							...
							<br />
							<br />
							It was our methodology and our teachers that allowed us to pass
							the certification of the Canary Islands Surfing Federation -
							FEDERACIÓN CANARIA DE SURF. This means that our school meets all
							international standards. Recertification is carried out annually
							and this allows us to always strive to improve training.
						</p>
					</div>
				</div>
			</div>
